...
define(['N/file', 'N/format', 'N/record', 'N/redirect', 'N/render', 'N/runtime', 'N/search', 'N/ui/serverWidget','N/config'],
    ...
    function(file, format, record, redirect, render, runtime, search,serverWidget,config) {
        ...
        function weekValues(recID,weekofDate,payDate,priorDate,driverData,truckIDs){
            var totalWeek = 0;
            var week_arr = [];
            var weekObj = {};
        ...
        function onRequest  (scriptContext) {
            try{
                if (scriptContext.request.method === 'GET') {
                    ...
                    headObj.week = weekValues(recID,rawDate,formatToday,formatPrior,driverData,truckID_arr);
