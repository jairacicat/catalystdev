...
define([
    ...
    '../STI_Lib/sti_process_invoice_module',
    ...
    function (serverWidget, REDIRECT, TASK, RECORD, RUNTIME, SEARCH, URL, SNOW, STIN, STINVC, STIUTIL) {
        ...
        function doUpdateFulfillableItems(context, appUrl) {
            ...
            try {
                ...
                if (justSkipIt) {
                    ...
                    var arrayItems = scriptObj.getParameter({ name: 'custscript_sti_fulfillable_items2' }).split(',');
                }
        ...
        function doSingleInvoiceEmail(context, appUrl) {
            try {
                ...
                //CTC 10-08-2024 - Call MR to send the Email
                var emailMRTask = TASK.create({
                    taskType: TASK.TaskType.MAP_REDUCE,
                    scriptId: 'customscript_ctc_mr_invoiceemail',
                    deploymentId: 'customdeploy_ctc_invoiceemail_single',
                    params: {
                        'custscript_ctc_invoice_id' : invoiceId
                    }
                });
                ...
                //CTC 08-08-2024 - Mark the Email Invoice Sent checkbox
                RECORD.submitFields({
                    type: 'invoice',
                    id: invoiceId,
                    values: {
