    ...
    function (record, search, log, rtnrutil) {
        ...
        function rtnr_afterSubmit(context) {
            ...
            if (context.type === 'create' || context.type === 'edit') {
                ...
                /*var retainerBudgetCalc = rtnrutil.getTotalParentRetainer(retainerId, customerId);
               ...
               /* 
               var retainerBudgetAdjCalc = rtnrutil.getTotalParentRetainer(retainerId, customerId);
