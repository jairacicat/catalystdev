 ...
 * 3.00     Feb 20, 2025    jcicat          Update to filter Credit Memos per Retainer
 *
 */
    ...
    define(['N/file', 'N/render', 'N/search', 'N/log', 'N/redirect', 'N/record',
        ...
        function (file, render, search, log, redirect, record, config, serverWidget) {
            ...
            function getCreditMemo(custId, retainerId) {
                    ...
                    try {
                        var creditSearch = search.create({
                            ...
                            filters: [
                                ...
                                "AND",
                                ["internalid", "anyof", custId, "customermain"],
                                "AND",
                                ["internalid", "anyof", retainerItem, "item"],
                                "AND",
                                [
                ...
                if (!isEmpty(custId)) {
                    try {
                        ...
                        var customerRetainerSearch = search.create({
                            ...
                            columns: ['internalid', 'name', 'custrecord_ctc_rtnr_total_budget', 'custrecord_ctc_rtnr_start_date', 'custrecord_ctc_rtnr_end_date', 'custrecord_ctc_rtnr_type', 'custrecord_ctc_rtnr_total_bgt_remaining', 'custrecord_ctc_rtnr_total_bgt_adjustment'] //ALI
                        });
                        ...
                        if (!isEmpty(retainerResult)) {
                            for (var i = 0; i < retainerResult.length; i++) {
                                ...
                                var retainerAdjustment = retainerResult[i].getValue({name: 'custrecord_ctc_rtnr_total_bgt_adjustment'});
