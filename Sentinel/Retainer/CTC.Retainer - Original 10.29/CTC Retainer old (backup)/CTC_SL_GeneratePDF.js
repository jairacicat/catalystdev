 ...
 */
 ...
 var retainerItem = ['118568', '284603', '284604']
                         ...
                         filters:
                             [
                                 [[["type", "anyof", "CustInvc"],
                                     ...
                                     "AND", ["item.internalid", "anyof", retainerItem],
                                     "AND", [["custbody_ctc_rtnr_so_retainer", "noneof", "@NONE@"],
                                         "OR", ["custbody_ctc_rtnr_inv_retainer", "noneof", "@NONE@"]]]]
                             ]
                         /*,
                         filters: [search.createFilter({
                             name: 'type',
