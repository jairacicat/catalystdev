 ...
 * 1.02      Feb 16, 2024        asaliba                  Add pop up when invoicing a retainer item without selecting a retainer record
 */
     ...
     function(currentRecord, log, search, rtnrutil) {
         ...
         function saveRecord(scriptContext) {
             ...
             for(var i=0; i <= itemCount-1; i++){
                 ...
                 if(itemId === rtnrutil.fields.retainerItemId || itemId == rtnrutil.fields.retainerItemId_ir || itemId == rtnrutil.fields.retainerItemId_advisory){ //ALI
